    ...
    <div class="infoBlock" v-if="configBlock.curMod=='edit'" :style="{minHeight: (sidebarHeight-290) + 'px'}">        
        ...
        <div class="contentBox">
             <div class="content"  style="width:100%;padding-top:26px;">
                 <!-- 表格 @sizeChange="sizeChange" @pageChange="pageChange" @add="add"  @remove="remove" @edit="edit" @buttonFunction="buttonFunction"-->
                <mytable style="margin-top:24px;" v-if="curNode && curNode.data.id>0" @selectChange="selectChangeTableEdit" :tableConfig="configBlock.modEdit.table.tableConfig" :border="false" :tableData="configBlock.modEdit.table.tableData"  @addLine="addLine"  @delLine="delLine"></mytable>
...
export default {
    ...
    computed:{
        ...
        isAddDataShow(){
            return this.curNode&&(this.configFilter[0].items.length>0)&&(this.configFilter[1].items.length>0) 
        }
    },
    data(){
        return {
