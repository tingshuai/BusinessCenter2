...
<div class="r">
    ...
    <div class="formdesign">
        <h3 class="design_title" style="margin-bottom:0;">运维方案 
                ...
                this.$refs.formSheme.validate((valid) => {
                    if (valid) {
                        if(that.mod=="add"){
                            ...
                            maintainSchemeAdd({Vue:that,params:params}).then(res=>{
                                // console.log("maintainSchemeAdd===>",res);
                                if(res.model){
                                    ...
                                    maintainDesignAdd({Vue:that,params:params}).then(res=>{
